...
function App() {
    const permaText= <div>We welcome you to an experiential, natural farming, permaculture workshop, at Solitude Farm in the international township of Auroville. <br></br><br></br>
...
return (
    ...
    <Header />
        <main>
            <Intro />
            <TextImage titleImg={require('./TextImage/images/WeekendParmacultureWorkshop.png')} pgId = 'perm-workshop' deskImg={require('./TextImage/images/perma.jpg')} mobImg={require('./TextImage/images/perma-mob.png')} text={permaText} mobText={permaMobText} linkTo={permaLink}/>
            <TextImage titleImg={require('./TextImage/images/EatLocalWeek.png')} pgId = 'eat-local' deskImg={require('./TextImage/images/eat-local.jpg')} mobImg={require('./TextImage/images/eat-local-mob.jpg')} text={eatLocalText} mobText={eatLocalMobText} linkTo={eatLocalLink}/>
        </main>
    </div>
  );
}
